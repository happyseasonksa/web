      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary" style="text-align: right;">
            <div class="card-header">
                <h3 class="card-title" style="float: right">{{__('List Invitations')}}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-hover table-responsive nowrap" style="width:100%;">
                <thead>
                    <tr>
                      <th>{{__('SR')}}</th>
                      <th>{{__('User')}}</th>
...
<script>
    ...
    $(function () {
        ...
        "lengthChange": false,
          ...
          "autoWidth": false,
          ajax: "{{ route('admin.invitation.index') }}",
          columns: [
