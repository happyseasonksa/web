          ...
          <div class="col-md-12" style="text-align: right;">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title" style="float:right;">{{__('sidebar.Add New Image Category')}}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{route('admin.image-category.store')}}" enctype="multipart/form-data" role="form" id="add-category">
                    @csrf
                    <div class="card-body">
