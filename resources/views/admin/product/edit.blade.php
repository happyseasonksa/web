            ...
            <div class="col-md-12" style="text-align: right;">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title" style="float: right;">{{__('Update')}} {{ucfirst($item->name)}}</h3>
                    </div><!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route('admin.item.update',['id'=>$item->id])}}" role="form" id="add-table-category" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="lat" value="{{$item->lat}}" id="latInput">
                        <input type="hidden" name="lng" value="{{$item->lng}}" id="lngInput">
                        <input type="hidden" name="remove_staff" id="remove_staff" value="">
                        <input type="hidden" name="remove_offers" id="remove_offers" value="">
                        <input type="hidden" name="remove_services" id="remove_services" value="">
                        <input type="hidden" name="remove_facilities" id="remove_facilities" value="">
                        <input type="hidden" name="remove_images" id="remove_images" value="">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">{{__('Name')}}</label>
                                <input type="text" name="name" class="form-control @error('name'){{'is-invalid'}}@enderror" value="{{$item->name}}" id="name" placeholder="{{__('Name')}}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control @error('phone'){{'is-invalid'}}@enderror" value="{{$item->phone}}" id="phone" placeholder="{{__('Phone')}}">
                                @error('phone')
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="select2 @error('category_id'){{'is-invalid'}}@enderror" data-placeholder="{{__('Select Category')}}" id="category_id" style="width: 100%;">
                                    @foreach($categories as $category_id)
                                        <option value=""></option>
                                        <option @if($item->category_id && $category_id->id == $item->category_id) selected @endif value="{{$category_id->id}}">{{$category_id->name}}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                            ...
                            <div class="form-group">
                                @php
                                    $subcategories = getSubCategories($item->category_id);
                                @endphp
                                ...
                                <select name="subcategory_id" class="select2 @error('subcategory_id'){{'is-invalid'}}@enderror" data-placeholder="{{__('Select Category')}}" id="subcategory_id" style="width: 100%;">
                                    @foreach($subcategories as $category_id)
                                        <option value=""></option>
                                        <option @if($item->subcategory_id && $category_id->id == $item->subcategory_id) selected @endif value="{{$category_id->id}}">{{$category_id->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="city_id" class="select2 @error('city_id'){{'is-invalid'}}@enderror" data-placeholder="{{__('Select City')}}"   id="city_id" style="width: 100%;">
                                    @foreach($cities as $city)
                                        <option value=""></option>
                                        <option @if($item->city_id && $city->id == $item->city_id) selected @endif value="{{$city->id}}" data-name="{{$city->name}}" data-arname="{{$city->ar_name}}" >{{$city->name}}</option>
                                    @endforeach
                                </select>
                                @error('city_id')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control @error('description'){{'is-invalid'}}@enderror" id="description" placeholder="{{__('Description')}}">{{$item->description}}</textarea>
                                @error('description')
                            ...
                            @if($item->services() && count($item->services()) > 0)
                                <div class="form-group show-services row">
                                    <label class="col-md-12" for="images">{{__('Services')}}</label>
                                    @foreach($item->services() as $service)
                                        <div class="col-md-12 row mt-2">
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" value="{{$service->service}}">
                                            </div>
                                            <span class="col-md-2">
                                    <button class="btn btn-danger btn-add" type="button" title="Remove Cooking Style" onclick="removeServices({{$service->id}},this)">
                            ...
                            @if($item->staff() && count($item->staff()) > 0)
                                <div class="form-group show-staff row">
                                    <label class="col-md-12" for="images">{{__('Staff')}}</label>
                                    @foreach($item->staff() as $service)
                                        <div class="col-md-12 row mt-2">
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" value="{{$service->service}}">
                                            </div>
                                            <span class="col-md-2">
                                    <button class="btn btn-danger btn-add" type="button" title="Remove Cooking Style" onclick="removeStaff({{$service->id}},this)">
                                        <span class="fa fa-minus"></span>
                                    </button>
                                </span>
                                        </div>
                            ...
                            @if($item->facilities() && count($item->facilities()) > 0)
                                <div class="form-group show-facilities row">
                                    <label class="col-md-12" for="images">{{__('Facilities')}}</label>
                                    @foreach($item->facilities() as $service)
                                        <div class="col-md-12 row mt-2">
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" value="{{$service->service}}">
                                            </div>
                                            <span class="col-md-2">
                                    <button class="btn btn-danger btn-add" type="button" title="Remove Cooking Style" onclick="removeFacilities({{$service->id}},this)">
                                        <span class="fa fa-minus"></span>
                                    </button>
                                </span>
                                        </div>
                            ...
                            @if($item->offers() && count($item->offers()) > 0)
                                <div class="form-group show-offers row">
                                    <label class="col-md-12" for="images">{{__('Offers')}}</label>
                                    @foreach($item->offers() as $service)
                                        <div class="col-md-12 row mt-2">
                                            <div class="col-md-10">
                                                <textarea type="text" name="offers[]" class="form-control editor @error('offers'){{'is-invalid'}}@enderror"  id="offers" placeholder="{{__('Offers')}}">{{$service->service}}</textarea>

                                            </div>
                                            <span class="col-md-2">
                                    <button class="btn btn-danger btn-add" type="button" title="Remove Cooking Style" onclick="removeOffers({{$service->id}},this)">
                                        <span class="fa fa-minus"></span>
                                    </button>
                                </span>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="openTimes" class="form-control  @error('openTimes'){{'is-invalid'}}@enderror" id="openTimes" placeholder="{{__('openTimes')}}">{{$item->openTimes}}</textarea>
                                @error('openTimes')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="website" class="form-control @error('website'){{'is-invalid'}}@enderror" value="{{$item->website}}" id="website" placeholder="{{__('website')}}">
                                @error('website')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="twitter" class="form-control @error('twitter'){{'is-invalid'}}@enderror" value="{{$item->twitter}}" id="twitter" placeholder="{{__('twitter link')}}">
                                @error('twitter')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="whatsapp" class="form-control @error('whatsapp'){{'is-invalid'}}@enderror" value="{{$item->whatsapp}}" id="whatsapp" placeholder="{{__('Whatsapp Link')}}">
                                @error('whatsapp')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook" class="form-control @error('facebook'){{'is-invalid'}}@enderror" value="{{$item->facebook}}" id="facebook" placeholder="{{__('Facebook Link')}}">
                                @error('facebook')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="instagram" class="form-control @error('instagram'){{'is-invalid'}}@enderror" value="{{$item->instagram}}" id="instagram" placeholder="{{__('Instagram Link')}}">
                                @error('instagram')
                            ...
                            {{--                                    <div class="card card-primary">--}}
                            {{--                                        <div class="card-header">--}}
                            {{--                                            <h6 class="card-title">{{__('Select Time')}}</h6>--}}
                            {{--                                        </div>--}}
                            {{--                                        <div class="card-body p-0">--}}
                            {{--                                            <table class="table table-stripe fix-table-column">--}}
                            {{--                                                <thead>--}}
                            {{--                                                <tr>--}}
                            {{--                                                    <th>{{__('Day')}}</th>--}}
                            {{--                                                    <th>{{__('All Day')}}</th>--}}
                            ...
                            {{--                                                @foreach(getAllDays() as $day)--}}
                            {{--                                                    <tr>--}}
                            {{--                                                        <td>{{__(ucfirst($day))}}</td>--}}
                            {{--                                                        <td>--}}
                            {{--                                                            <input type="checkbox" class="check_daily" name="{{$day}}_daily" value="1" @if(old($day.'_daily')) checked @endif id="{{$day}}_daily" data-day="{{$day}}">--}}
                            {{--                                                        </td>--}}
                            {{--                                                        <td>--}}
                            {{--                                                            <input type="text" name="{{$day}}_from" class="form-control" value="{{old($day.'_from')}}" id="{{$day}}_from" placeholder="{{__('From')}}">--}}
                            {{--                                                        </td>--}}
                            {{--                                                        <td>--}}
                            {{--                                                            <input type="text" name="{{$day}}_to" class="form-control" value="{{old($day.'_to')}}" id="{{$day}}_to" placeholder="{{__('To')}}">--}}
                            {{--                                                        </td>--}}
                            {{--                                                        <td>--}}
                            {{--                                                            <select name="{{$day.'_action'}}" class="custom-select" id="{{$day.'_action'}}">--}}
                            {{--                                                                <option @if(old($day.'_action') == '0') selected @endif value="0">{{__('Off')}}</option>--}}
                            {{--                                                                <option @if(old($day.'_action') == '1') selected @endif value="1">{{__('Open')}}</option>--}}
                            {{--                                                            </select>--}}
                            {{--                                                        </td>--}}
                            {{--                                                    </tr>--}}
                            {{--                                                @endforeach--}}
                            ...
                            @if($item->images && count($item->images) > 0)
                                <div class="row">
                                    <label class="col-md-12" for="images">{{__('Images')}}</label>
                                    @foreach($item->images as $image)
                                        <div class="col-md-6 input-group form-group">
                                            <img src="{{asset($image->source)}}" width="100" height="100">
                                            <span class="mx-1 input-group-btn">
                                    <button class="btn btn-danger btn-add" type="button" title="Remove Image" onclick="removeImage({{$image->id}},this)">
                                        <span class="fa fa-minus"></span>
                                    </button>
                                </span>
                                        </div>
                            ...
                            <div class="row image-container @error('images'){{'is-invalid'}}@enderror">
                                <label class="col-md-12" for="images">{{__('Add More Images')}}</label>
                                <div class="entry col-md-6 input-group form-group">
                                    ...
                                    <span class="input-group-btn">
                                    <button class="btn btn-success btn-add" type="button" title="Add Image">
                                        <span class="fa fa-plus"></span>
                                    </button>
                                </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="custom-select @error('status'){{'is-invalid'}}@enderror" id="status">
                                    <option @if($item->status == 1) selected @endif value="1">{{__('Active')}}</option>
                                    <option @if($item->status == 0) selected @endif value="0">{{__('InActive')}}</option>
                                </select>
                                @error('status')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" class="form-control @error('address'){{'is-invalid'}}@enderror" value="{{$item->address}}" id="address" placeholder="{{__('Address')}}">
                                @error('address')
...
@section('js-body')
    ...
    <script>
        var removeServicesInput = $('#remove_services');
        var removestaffInput = $('#remove_staff');
        var removefacilitiesInput = $('#remove_facilities');
        var removeoffersInput = $('#remove_offers');
        ...
        // remove cooking style
        function removeServices(id, btn) {
            var value = removeServicesInput.val();
            if (value == '') {
                removeServicesInput.val(id);
            }else{
                var concat = value+','+id;
                removeServicesInput.val(concat);
            }
            var container = $(btn).closest(".show-services");
        ...
        // remove cooking style
        function removeStaff(id, btn) {
            var value = removestaffInput.val();
            if (value == '') {
                removestaffInput.val(id);
            }else{
                var concat = value+','+id;
                removestaffInput.val(concat);
            }
            var container = $(btn).closest(".show-staff");
            if (container.children('div').length > 1) {
                $(btn).closest(".col-md-12").remove();
            }else{
                container.remove();
        ...
        // remove cooking style
        function removeFacilities(id, btn) {
            var value = removefacilitiesInput.val();
            if (value == '') {
                removefacilitiesInput.val(id);
            }else{
                var concat = value+','+id;
                removefacilitiesInput.val(concat);
            }
            var container = $(btn).closest(".show-facilities");
            if (container.children('div').length > 1) {
                $(btn).closest(".col-md-12").remove();
            }else{
                container.remove();
        ...
        // remove cooking style
        function removeOffers(id, btn) {
            var value = removeoffersInput.val();
            if (value == '') {
                removeoffersInput.val(id);
            }else{
                var concat = value+','+id;
                removeoffersInput.val(concat);
            }
            var container = $(btn).closest(".show-offers");
            if (container.children('div').length > 1) {
                $(btn).closest(".col-md-12").remove();
            }else{
                container.remove();
    ...
    <script>
        ...
        var cityInput = $('#city');
        var removeImageInput = $('#remove_images');
        var marker;
        ...
        function removeImage(id, btn) {
            var value = removeImageInput.val();
            if (value == '') {
                removeImageInput.val(id);
            }else{
                var concat = value+','+id;
                removeImageInput.val(concat);
            }
            var container = $(btn).closest(".row");
            if (container.children('div').length > 1) {
