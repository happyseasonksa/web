      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary" style="text-align: right;">
            <div class="card-header">
                <h3 class="card-title" style="float: right">{{__('List Contact us')}}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-hover nowrap" style="width:100%;">
                <thead>
                    <tr>
                      <th>{{__('SR')}}</th>
                      <th>{{__('Name')}}</th>
          ...
          columns: [
              ...
              {data: 'email', name: 'email'},
              {
                ...
                "render": function (data, type, row, meta) {
                    return `${(row['phone_code'])?row['phone_code']:''}${row['phone']}`;
                }
              },
              {
                data: "message",
